                ...
                <div class="formContainer">
                    <div>
                        <form action="" method="GET"  id="contactForm">
                            <div class="inputText">
                                <label for="username">Name - <span id="usernameError" class=""></span></label>
                            ...
                            <div class="inputText">
                                <label for="phone">Phone Number - <span id="phoneError" class=""></span></label>
                                <input type="tel" id="phone" name="phone" placeholder="Enter Phone Number"/>
                            </div>

                            <div class="inputText">
                                <label for="address">Address - <span id="addressError" class=""></span></label>
                                <input type="text" id="address" name="address" placeholder="Enter Address"/>
                            </div>


                            <div class="submitBtn">
                                <input id="ubtn" onClick="hide()" type="Order" value="Send"/>
                            </div>
                        </form>
                    </div>
                </div>
